...
model consisting of two sub-modules: the brain model and the body-environment model.
...
The simulation above is animating the exact data readout from the BAAIWorm simulator
from [here](https://github.com/Jessie940611/BAAIWorm).
