...
set of basic actions, however the agent learns to flexibly compose these into hierarchies of complex tool use to be able to accompolish the in-game achievements such as acquiring diamonds
