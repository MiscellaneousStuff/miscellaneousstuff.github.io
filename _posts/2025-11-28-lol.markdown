...
The key question for this project is, within the next year is it feasible that a visual largue language model (vLLM) such as Grok 5 could genuinely
...
So, has this type of thing been done before? Yes, multiple MOBA-style games have had AI-based systems beat professional teams, ranging from Dota 2 (OpenAI Five),
Honor of Kings - which is a game very similar to League of Legends (JueWu-SL), etc.

However, the nature of Grok 5 being the agent along with the purely visual input changes things drastically.