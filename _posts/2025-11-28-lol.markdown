...
- [League Data Scraping](https://maknee.github.io/blog/2025/League-Data-Scraping/) - Packet-based approach at producing League of Legends training datasets at scale (in constrast to tlol-py, from Henry Zhu at University of Illinois Urbana-Champaign)
...
the offsets (akin to the allies having to re-crack the enigma cipher used by the German's daily during
